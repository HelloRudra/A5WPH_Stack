...
function BrandLogo() {
  return (
    <div className="flex items-center gap-2">
      <span className="flex h-9 w-9 items-center justify-center rounded-lg brand-gradient-bg text-sm font-bold text-white">
        DS
      </span>
    ...
    <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/90 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <a href="#" className="hidden text-sm font-medium text-slate-700 hover:text-slate-900 sm:block">
            Sign In
          </a>
          <a
            href="#"
              ...
              <li key={link}>
                <a
                  ...
                  className={`block rounded-md px-3 py-2 text-sm font-medium ${
                    i === 0 ? "text-pink-600" : "text-slate-600"
                  }`}
                >
                  {link}
                </a>
